...
<div style="width:700;padding-top:5px; float:left;">
 <h2>Filtros do Ticket</h2>
</div>
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
 <b><a href="filters.php?a=add" class="Icon newEmailFilter">Adicionar novos filtros</a></b></div>
<div class="clear"></div>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        Tens a certeza de querer <b>habilitar</b> os filtros selecionados?
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        ATens a certeza de querer <b>desabilitar</b>  os filtros selecionados?
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong>Tens a certeza de querer DELETAR os filtros selecionados?</strong></font>
        <br><br>Filtros excluídos não podem ser recuperados, incluindo todas as regras associadas.
    </p>
