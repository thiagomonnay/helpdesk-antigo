...
?>
<h2>Template para mensagem de e-mail - <span><?php echo $template->getName(); ?></span></h2>
<div style="padding-top:10px;padding-bottom:5px;">
    <form method="get" action="templates.php">
    <input type="hidden" name="id" value="<?php echo $template->getId(); ?>">
    <input type="hidden" name="a" value="manage">
    Menssagem do template:
    <select id="tpl_options" name="tpl" style="width:300px;">
        <option value="">&mdash; Selecione as configurações do grupo &mdash;</option>
        <?php
   ...
   <thead>
     <tr>
        <th colspan="2">
            ...
            <em>Assunto e o corpo são obrigatórios.  <a class="tip" href="ticket_variables.txt">Variáveis suportadas</a>.</em>
        </th>
     </tr>
    </thead>
    <tbody>
        <tr>
            <td colspan=2>
                <strong>Assunto da mensagem:</strong> <em>Assunto da mensagem do e-mail</em> <font class="error">*&nbsp;<?php echo $errors['subj']; ?></font><br>
                <input type="text" name="subj" size="60" value="<?php echo $info['subj']; ?>" >
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <strong>Corpo da mensagem:</strong> <em>Mensagem do corpo do e-mail.</em> <font class="error">*&nbsp;<?php echo $errors['body']; ?></font><br>
...
<p style="padding-left:210px;">
    ...
    <input class="button" type="button" name="cancel" value="Cancelar Alterações" onclick='window.location.href="templates.php?id=<?php echo $template->getId(); ?>"'>
</p>
</form>
