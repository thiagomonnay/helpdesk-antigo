<?php
if(!defined('OSTCLIENTINC') || !is_object($thisclient) || !$thisclient->isValid() || !$cfg->showRelatedTickets()) die('Acesso negado!');
    ...
    <?php
     if($res && ($num=db_num_rows($res))) {
        ...
        <?php
         ...
         echo '<tr><td colspan="7">Sua pesquisa não encontrou registros</td></tr>';
     }
    ?>
    </tbody>
</table>
